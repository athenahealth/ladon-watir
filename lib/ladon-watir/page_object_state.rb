...
# Models the features exposed by and the transitions available from instances
# of this State class.
#
...
class PageObjectState < Ladon::Modeler::State
  ...
  def self.model_html
    ...
    #
    # Our PageObject-style States really want to have instance-level modeling,
    # since each instance may be created under different context in-ruby-
    # process, and we don't want them conflicting.
    #
    # So, we're using this approach so we can put our HTML modeling on the per-
    # instance singleton class of each PageObjectState instance.
